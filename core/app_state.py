...
from core.home_layout import HomeLayoutStore
...
class AppState:
    def __init__(self):
        self.module_manager = ModuleManager(appconfig.load_module_states, appconfig.save_module_states, BUILTIN_MODULES)
