...
def same_origin(request: Request, request_is_secure: Callable[[Request], bool]) -> bool:
    ...
    effective_scheme = "https" if request_is_secure(request) else "http"
...
def install_authentication_middleware(
    ...
    async def require_authentication(request: Request, call_next):
        ...
        if request.method in UNSAFE_METHODS and not same_origin(
            request, dependencies.request_is_secure,
        ):
