const i18n = (() => {
  ...
  const LOCAL_TRANSLATIONS = {
    en: new Map(Object.entries({
      ...
      "Übersicht": "Overview",
      "Alle Systembereiche": "All system areas",
      "Betrieb": "Operations",
      "Modus, Sprache & Speicher": "Mode, language & storage",
      "Speicher": "Storage",
      "Live-Belegung & Bereinigung": "Live usage & cleanup",
      "Katalog & Routing": "Catalog & routing",
      "Dienste": "Services",
      "Prüfpläne & Zeitfenster": "Check schedules & time windows",
      "Anmeldung & Sitzungen": "Login & sessions",
      "Wartung": "Maintenance",
