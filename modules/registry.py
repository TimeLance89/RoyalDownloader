...
BUILTIN_MODULES = (
    ...
    ModuleManifest("royal-intelligence", "Royal Intelligence", "Kuratiert ausschließlich vorhandene Startseiten-Kandidaten über einen konfigurierten Provider.", "Intelligence", {"cpu":"Niedrig","ram":"Niedrig","network":"Bei Anfrage","storage":"Niedrig"}, (), default_enabled=False),
)
