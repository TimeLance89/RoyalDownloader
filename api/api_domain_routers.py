...
from api.api_automation_policy_router import router as automation_policy_router
from api.api_serienstream_verification_router import router as serienstream_verification_router
from api.api_storage_router import router as storage_router
