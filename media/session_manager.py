...
class SessionManager:
    ...
    def _serienstream_browser_html(self, url: str) -> Optional[str]:
        try:
            from integrations.serienstream_shared_session import fetch_provider_html
    ...
    def _serienstream_browser_redirect(self, url: str, referer: str) -> Optional[str]:
        try:
            from integrations.serienstream_shared_session import resolve_provider_redirect
    ...
    async def _nodriver_async(self, url: str) -> Optional[str]:
        ...
        import core.nodriver_patch as nodriver_patch
